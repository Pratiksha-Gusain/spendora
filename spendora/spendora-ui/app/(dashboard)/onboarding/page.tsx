...
const languages = [
  { code: 'ENGLISH', name: 'English', localName: 'US / UK', icon: 'ENG' },
  { code: 'HINDI', name: 'Hindi', localName: 'हिन्दी', icon: 'HIN' },
] as const;
    ...
    <div className="min-h-screen bg-[#030712] flex flex-col items-center py-12 px-6 relative overflow-x-hidden">
      ...
      <div className="text-center mb-8 space-y-2">
        ...
        <h1 className="text-4xl font-extrabold text-white tracking-tight sm:text-5xl">
          Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400"> Spendora</span>
        </h1>
